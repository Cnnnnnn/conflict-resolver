...
// Hard ceiling for any git subprocess. Without it a stalled network operation
// (e.g. `git fetch`, `merge-tree` against a slow remote) would hang the promise
// forever and leave the UI stuck on "loading". On timeout the child is killed
// and the call rejects with a GitCommandError.
